...
class News(models.Model):
    ...
    image = models.ImageField(upload_to='news_images/', blank=True ,verbose_name="Изображение")  # Поле для хранения картинки (требуется установить библиотеку Pillow)
...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='store_images/', blank=True ,verbose_name="Картинка товара")
...
class Category_prod(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('show_prod_category', kwargs={'cat_id': self.pk})
